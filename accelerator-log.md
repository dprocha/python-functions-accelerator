...
```json
{
  "functionName" : "hello",
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/dprocha/python-functions-accelerator.git",
  "includeTap" : true,
  "interfaceType" : "http",
  "projectName" : "python-functions"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/sample-accelerators/python-functions-accelerator.git->https://github.com/d...(truncated), main->main]
